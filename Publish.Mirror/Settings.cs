...
namespace Tridion.Events
{
    ...
    static class Settings
    {
        ...
        /// <summary>
        /// Only mirror if the propogate to children setting is selected.
        /// </summary>
        public static bool MIRROR_IF_PROPOGATE_SELECTED = Configuration.GetBooleanAppSetting("MirrorIfPropogateSelected");
